...
import ua.pp.russian.repository.SubjectRepository;
import ua.pp.russian.service.SubjectService;
import ua.pp.russian.service.dto.SubjectDTO;
import ua.pp.russian.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ua.pp.russian.domain.Subject}.
 */
@RestController
@RequestMapping("/api")
