  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rfEduApp.type.home.createOrEditLabel" data-cy="TypeCreateUpdateHeading">
            <Translate contentKey="rfEduApp.type.home.createOrEditLabel">Create or edit a Type</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rfEduApp.type.name')}
                id="type-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('rfEduApp.type.picture')}
                id="type-picture"
                name="picture"
                data-cy="picture"
                type="text"
