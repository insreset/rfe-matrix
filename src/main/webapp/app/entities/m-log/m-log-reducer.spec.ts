...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './m-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_MLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MLOG actions', async () => {
      const expectedActions = [
        {
