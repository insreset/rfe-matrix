    ...
    <Row>
      <Col md="8">
        <h2 data-cy="languageDetailsHeading">
          <Translate contentKey="rfEduApp.language.detail.title">Language</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="rfEduApp.language.name">Name</Translate>
            </span>
          </dt>
          <dd>{languageEntity.name}</dd>
          <dt>
            <span id="picture">
              <Translate contentKey="rfEduApp.language.picture">Picture</Translate>
            </span>
          </dt>
          <dd>{languageEntity.picture}</dd>
        </dl>
