...
class LanguageResourceIT {
    ...
    public static Language createEntity(EntityManager em) {
        Language language = new Language().name(DEFAULT_NAME).picture(DEFAULT_PICTURE);
        return language;
    }
    ...
    public static Language createUpdatedEntity(EntityManager em) {
        Language language = new Language().name(UPDATED_NAME).picture(UPDATED_PICTURE);
        return language;
    }
    ...
    void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getPicture()).isEqualTo(DEFAULT_PICTURE);
    }
    ...
    void putNewLanguage() throws Exception {
        ...
        updatedLanguage.name(UPDATED_NAME).picture(UPDATED_PICTURE);
        ...
        assertThat(testLanguage.getPicture()).isEqualTo(UPDATED_PICTURE);
    }
    ...
    void fullUpdateLanguageWithPatch() throws Exception {
        ...
        partialUpdatedLanguage.name(UPDATED_NAME).picture(UPDATED_PICTURE);
